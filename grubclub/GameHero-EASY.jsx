...
export default function GameHeroEasy() {
  ...
  return (
    <div style={{ 
      ...
      <h1 style={{ color: 'white', textAlign: 'center', marginBottom: 30 }}>
        🎮 Game Hero
      </h1>
      ...
      <div style={{ 
        ...
        {LIVE_GAMES.map(game => (
          ...
          >
            <span style={{ fontSize: 60 }}>{game.cover}</span>
            <span style={{ color: 'white', fontWeight: 'bold' }}>{game.title}</span>
            {game.mobile && (
              <span style={{ color: '#4ade80', fontSize: 10 }}>📱 Mobile</span>
            )}
          </button>
        ))}
      </div>
