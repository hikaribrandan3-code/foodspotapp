        ...
        <div className="print-menu-container">
            ...
            >
                <div className="menu-header">
                    ...
                    <div className="header-divider" data-separator={separatorStyle} />
                </div>
                ...
                <div className="menu-body">
                    {categories.map((category) => (
                        <div key={category.id || category.name} className="menu-category">
                            ...
                            <div className="category-divider" data-separator={separatorStyle} />
                ...
                <div className="menu-footer">
                    <div className="footer-divider" data-separator={separatorStyle} />
