...
export function VenueMap({ selectedZone, onSelectZone }) {
  return (
    <div className="w-full rounded-[32px] p-4 border overflow-hidden"
      style={{ backgroundColor: 'var(--surface-bg, #fff)', borderColor: 'var(--border-subtle, rgba(0,0,0,0.06))' }}
    >
      <div className="flex items-center justify-between mb-4 px-2">
        <div>
          <h3 className="text-[10px] font-black opacity-40 uppercase tracking-[0.2em] mb-1">Interactive Site Map</h3>
          <p className="text-[9px] font-bold opacity-30">Festival Grounds • North Stage</p>
        </div>
        ...
        >
          ...
          <span className="text-[8px] font-black text-emerald-600 uppercase tracking-wider">Live Availability</span>
        </div>
      </div>
      ...
      <div className="relative aspect-[16/10] w-full">
        <svg viewBox="0 0 400 250" className="w-full h-full">
          ...
          />
          <text x="55" y="100" textAnchor="middle" className={`pointer-events-none text-[7px] font-black uppercase transition-colors ${
