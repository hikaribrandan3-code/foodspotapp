...
const characters = [
  ...
  { id: 'watermelon', name: 'Watermelon', phoneColor: '#DC2626' },
  ...
  return (
    <div style={{ padding: '20px', maxWidth: '400px', margin: '0 auto' }}>
      <style>{`
        ...
        .char-bounce { animation: bounce 1.2s ease-in-out infinite; animation-delay: 0.7s; }
      `}</style>
      ...
      <div style={{
        ...
        >
          ...
          <g transform="translate(258, 265) rotate(18) scale(1.5)">
            ...
            <path d="M 3 4 L 15 4" stroke="#FBCFE8" strokeWidth="1.5" strokeLinecap="round" opacity="0.8"/>
            <rect x="3" y="3" width="12" height="12" rx="3.5" fill={current.phoneColor} stroke="#1E293B" strokeWidth="1.5" style={{ filter: 'brightness(0.8)' }}/>
