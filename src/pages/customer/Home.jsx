...
// --- MENU: Fork & Knife (Crossed, Thick, Rounded)
const MenuIcon = () => (
    <svg width="36" height="36" viewBox="0 0 24 24" fill="currentColor">
        <path d="M7.33 2.5C7.9 1.9 8.85 1.9 9.4 2.5L21.5 14.6C22.1 15.2 22.1 16.1 21.5 16.7L19.2 19C18.6 19.6 17.7 19.6 17.1 19L14.6 16.5L12 19.1L8.5 22.6C7.9 23.2 7 23.2 6.4 22.6L1.4 17.6C0.8 17 0.8 16.1 1.4 15.5L4.9 12L2.5 9.6C1.9 9 1.9 8.1 2.5 7.5L5.2 4.8L7.33 2.5ZM17.5 14L9.5 6L6.5 9L14.5 17L17.5 14Z" />
        <path d="M19.5 6.5C19.5 6.5 19.5 6.5 19.5 6.5L16 10L14 8L16.2 5.8C16.6 5.4 17.2 5.4 17.6 5.8L19.5 7.7C19.9 8.1 19.9 8.7 19.5 9.1L19.5 6.5Z" opacity="0.0" />
        {/* Adjusted crossed path for visual match */}
        <path d="M10.15 4.79C10.68 4.26 11.53 4.26 12.06 4.79L19.21 11.94C19.74 12.47 19.74 13.32 19.21 13.85L16.42 16.64L13 13.22L7.36 7.58L10.15 4.79Z" />
        <path d="M14.93 18.06L17.71 20.85C18.24 21.38 19.09 21.38 19.62 20.85L21.03 19.44C21.56 18.91 21.56 18.06 21.03 17.53L14.93 18.06Z" opacity="0" />
        {/* Full composite path to match "Crossed" look in render */}
        <path fillRule="evenodd" clipRule="evenodd" d="M12.75 3.32a2.2 2.2 0 013.11 0l4.82 4.82a2.2 2.2 0 010 3.11l-2.07 2.07-2.73-2.73-3.69-3.69-2.73-2.73 3.29-3.29zM15.46 13.91l2.73 2.73 2.07-2.07a2.2 2.2 0 000-3.11l-1.95-1.95-12.77 12.78a2.19 2.19 0 01-3.1 0l-1.63-1.63a2.19 2.19 0 010-3.1l11.41-11.41 3.24 3.24zM5.34 3.79a2.2 2.2 0 013.11 0l11.76 11.76a2.2 2.2 0 010 3.11l-1.63 1.63a2.2 2.2 0 01-3.11 0L3.71 8.53a2.2 2.2 0 010-3.11l1.63-1.63z" />
    </svg>
)
...
// --- GAME: Game Controller (Solid, Chunky)
const GameIcon = () => (
    <svg width="36" height="36" viewBox="0 0 24 24" fill="currentColor">
