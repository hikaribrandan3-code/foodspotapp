            ...
            <div style={{
                ...
                <div>
                    ...
                    {isPillEnabled('adminAccess') && (
                        <button
                            style={{ background: 'none', border: 'none', cursor: 'pointer', padding: '12px', display: 'flex', alignItems: 'center', justifyContent: 'center', marginTop: '12px' }}
                            onClick={() => navigate(`/${tenantSlug}/owner`)}
                            title={t('info_admin_access')}
                        >
                            <svg width="32" height="32" viewBox="0 0 512 512" fill={getPillColor('adminAccess')} xmlns="http://www.w3.org/2000/svg">
