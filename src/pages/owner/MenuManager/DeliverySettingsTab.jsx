          ...
          <div className="bg-white rounded-2xl border border-stone-200 p-3 md:p-4 flex flex-col shadow-sm transition-all hover:shadow-md">
            <div className="flex justify-between items-center mb-2 text-left">
              <div>
                ...
                <h3 className="text-sm md:text-base text-stone-950 font-['Outfit',sans-serif] font-black italic">{t('base_fee') || 'Base Fee'}</h3>
              </div>
              <label className="relative flex cursor-pointer items-center">
                <input
                  type="checkbox"
            ...
            <div className={`relative transition-all duration-500 ${isDeliveryFeeEnabled ? 'opacity-100' : 'opacity-20 scale-95'}`}>
              ...
              <input
                ...
                className="w-full bg-stone-50 text-stone-950 font-['Outfit',sans-serif] font-black pl-8 py-2.5 rounded-xl focus:bg-white transition-all text-xl md:text-2xl outline-none"
                placeholder="0.00"
              />
            </div>
          </div>

          <div className="bg-emerald-600 rounded-2xl p-3 md:p-4 flex flex-col shadow-lg shadow-emerald-900/10 relative overflow-hidden">
            ...
            <div className="flex justify-between items-center mb-2 relative z-10 text-left">
              <div>
                ...
                <h3 className="text-sm md:text-base text-white font-['Outfit',sans-serif] font-black italic">{t('free_delivery_above') || 'Free Delivery Above'}</h3>
              </div>
              <label className="relative flex cursor-pointer items-center">
                <input
                  type="checkbox"
            ...
            <div className={`relative z-10 transition-all duration-500 ${isFreeDeliveryEnabled ? 'opacity-100' : 'opacity-20 scale-95'}`}>
              ...
              <input
                ...
                className="w-full bg-white/10 text-white font-['Outfit',sans-serif] font-black pl-8 py-2.5 rounded-xl focus:bg-white/20 transition-all text-xl md:text-2xl outline-none placeholder-white/20"
                placeholder="--.--"
              />
            </div>
          </div>
