    ...
    return (
        <div className="min-h-screen bg-stone-50 dark:bg-[#020617] font-sans antialiased">
            ...
            <main className="px-4 md:px-8 pt-5 md:pt-8 pb-28 space-y-5 md:space-y-6 max-w-3xl mx-auto w-full">
                ...
                {/* Locations Management — merged locations + config */}
                        ...
                        <div className="rounded-2xl overflow-hidden bg-white dark:bg-[#1e293b] border border-stone-200 dark:border-white/5 shadow-[0_20px_50px_rgba(28,25,23,0.03)]">
                            <AnimatePresence>
                                {openSections.multiLocation && (
                                    ...
                                    >
                                        {/* Location Switcher */}
                                        <div className="px-5 pt-4 pb-3 border-b border-stone-200 dark:border-white/10">
                                            ...
                                            <div className="flex flex-wrap gap-2">
                                                {locationsLoading ? (
                                                    <div className="text-xs text-stone-400 dark:text-white/30">Loading...</div>
                                                ) : ownerLocations.length === 0 ? (
                                                    <div className="text-xs text-stone-400 dark:text-white/30">
                                                        {t('no_locations_yet') || 'No locations yet.'}
                                                    </div>
                                                ) : (
                                        ...
                                        {ownerLocations.length >= 2 && (
                                            <div className="space-y-4 p-5">
                                                ...
                                                <div>
                                                    <label className="text-[10px] font-bold uppercase tracking-[0.15em] text-stone-400 dark:text-white/40 mb-2 block">
                                                        {t('brand_logo') || 'Hub Brand Logo'}
                                                    </label>
                                                    <div className="relative w-full h-32 bg-stone-100 dark:bg-white/5 border border-stone-200 dark:border-white/10 rounded-lg overflow-hidden">
                                                        {parentBrandLogo ? (
                                ...
                                <div className="rounded-2xl overflow-hidden bg-white dark:bg-[#1e293b] border border-stone-200 dark:border-white/5 p-4 md:p-5 space-y-4 shadow-[0_20px_50px_rgba(28,25,23,0.03)]">
                                    <div>
                                        ...
                                        <input
                                            ...
                                            placeholder={t('phone_placeholder') || '(+54) 9 1234-5678'}
                                            className="w-full px-4 py-2.5 rounded-2xl text-sm font-medium bg-stone-50 dark:bg-[#334155] border-0 text-stone-950 dark:text-white placeholder-stone-400 dark:placeholder-[#64748b] outline-none focus:bg-white transition-all shadow-sm"
                                        />
                                    </div>
