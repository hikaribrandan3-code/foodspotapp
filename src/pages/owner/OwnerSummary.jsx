                    ...
                    <div className="rounded-2xl overflow-hidden bg-white dark:bg-[#1e293b] border border-stone-200 dark:border-white/5 shadow-[0_20px_50px_rgba(28,25,23,0.03)]">
                        <div className="flex items-center justify-between px-4 py-3.5">
                            <div className="flex items-center gap-3">
                                ...
                                <div>
                                    <p className="text-sm font-bold text-stone-950 dark:text-white">Dine-In Reservations</p>
                                    <p className="text-xs text-stone-400 dark:text-stone-400">Show reservation button to customers</p>
                                </div>
                            </div>
