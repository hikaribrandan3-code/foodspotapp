-- Fix: Correct column reference in get_ai_menu_context RPC
-- The function was referencing c.enabled but the column is c.is_enabled
-- This was causing all calls to crash with: column c.enabled does not exist
